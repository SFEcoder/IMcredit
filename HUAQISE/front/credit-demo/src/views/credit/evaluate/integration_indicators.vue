                        ...
                        >
                            <div class="row">
                                ...
                                <div class="col-md-6 evaluate_col_box">
                                    ...
                                    <!--                                    网上采购率（%） ( 0 - 100 )-->
                                    <div v-if="enterprise_evaluate_type === 2 || this.enterprise_evaluate_type === 4 || this.enterprise_evaluate_type === 5" class="evaluate_input_box">
                                    ...
                                    <!--                                   当年企业生产设备总资产（万元） -->
                                    <div v-if="this.enterprise_evaluate_type === 3 || this.enterprise_evaluate_type === 5" class="evaluate_input_box">
...
<!--                                    通过信息化全面落实企业战略规划，实现全面预算管理的情况（-5~0）-->
                                    <div v-if="this.enterprise_evaluate_type === 1 || this.enterprise_evaluate_type === 2 || this.enterprise_evaluate_type === 4" class="evaluate_input_box">
...
<!--                                    信息化规划执行情况（0~9）-->
                                    <div v-if="this.enterprise_evaluate_type === 1 || this.enterprise_evaluate_type === 2 || this.enterprise_evaluate_type === 3" class="evaluate_input_box">
                                    ...
                                    <div v-if="this.enterprise_evaluate_type === 4 || this.enterprise_evaluate_type === 5" class="evaluate_input_box">
...
<!--                                    通过信息化实现业务协同和一体化情况-->
                                    ...
                                    <div v-if="this.enterprise_evaluate_type === 2 || this.enterprise_evaluate_type === 3 || this.enterprise_evaluate_type === 5"  class="evaluate_input_box">
                                    ...
                                    <div v-if="this.enterprise_evaluate_type === 2 || this.enterprise_evaluate_type === 3" class="evaluate_input_box">
...
<!--                                   信息系统运维投入占信息化总投入的比例（%） -->
                                    <div v-if="this.enterprise_evaluate_type === 1 || this.enterprise_evaluate_type === 2 || this.enterprise_evaluate_type === 3 || this.enterprise_evaluate_type === 4" class="evaluate_input_box">
...
<!--                                通过信息化实现与产业链企业间业务协同情况（0~10）-->
                                    <div v-if="this.enterprise_evaluate_type === 1 || this.enterprise_evaluate_type === 3 " class="evaluate_input_box">
...
<!--                                 通过信息化实现与产业链企业间业务协同情况（0~10）-->
                                    ...
                                    <!--                                    企业组织模式（0~9）-->
                                    <div v-if="this.enterprise_evaluate_type === 1 || this.enterprise_evaluate_type === 2 || this.enterprise_evaluate_type === 3 || this.enterprise_evaluate_type === 4 || this.enterprise_evaluate_type === 5" class="evaluate_input_box">
                        ...
                        <hr/>
<!--                        确定按钮-->
                            <button class="btn purple_color_btn center-block btn-getit btn_pick_text" @click="integration_indicators_done">
                                下一步
                            </button>
<!--                        确定按钮-->
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            is_a_number(num_str) {
                let num_float = parseFloat(num_str)
                if (num_float.toString() === "NaN") {
                    return false
                }
                return true
            },
            ...
            //    修改原先的值
                console.log(processIndustry_integration)
            },
            ...
            mixed_industry_integration_indicators_finished(){
                ...
                //    修改原先的值
                console.log(mixedIndustry_integration)
            }
        }
    }
</script>
