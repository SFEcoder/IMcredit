                ...
                {rules: [{ required: true, message: '请输入密码' }], validateTrigger: 'blur'}
                    ...
                    <a-form-item>
                        <div style="width: 200px;height: 100px;position: absolute; left: 50%;margin-left: 100px">
                            <a-radio-group name="radioGroup"   style="vertical-align: middle ; display: block ; margin: 0 auto">
                                <a-radio value="1" @click="changePersonal" checked>
                                    个人
                                </a-radio>
                                <a-radio value="2" @click="changeEnterprise">
                                    企业
                                </a-radio>
                            </a-radio-group>
                        </div>
                    ...
                    <a-form-item style="margin-top:24px" >
                      ...
                      <div style="margin-top: 70px; text-align: center">
                        <a href="#/credit/display" style="color: rgb(105,0,75)">游客浏览（免登录）</a>
                      </div>
    ...
    export default{
        ...
        methods:{
            ...
            customRequest (data) {
                ...
                this.uploadADImg(formData).then((res)=>{
                    data.onSuccess()
                })
